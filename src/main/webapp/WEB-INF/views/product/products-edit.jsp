...
<div class="container">
  ...
  <form action="<%= request.getContextPath() %>/products/edit" method="post">
    ...
    <div class="mb-3">
      ...
      <input type="number" class="form-control" id="amount" name="amount" value="<%= ((ProductDto) request.getAttribute("product")).getAmount() %>" required min="0">
    </div>
    <div class="mb-3">
      <label for="price" class="form-label">Price</label>
      <input type="number" step="0.01" class="form-control" id="price" name="price" value="<%= ((ProductDto) request.getAttribute("product")).getPrice() %>" required min="0">
    </div>
    <div class="mb-3">
